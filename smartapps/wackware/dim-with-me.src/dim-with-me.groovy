...
//subscribe(masters, "colorTemperature", switchSetColorHandler)
...
/*def switchSetColorHandler(evt)
{	
log.info "switchSetColorHandler Event: ${masters.latestValue("colorTemperature")}" 
slaves?.setColorTemperature(masters.latestValue("colorTemperature")) 
}
*/
